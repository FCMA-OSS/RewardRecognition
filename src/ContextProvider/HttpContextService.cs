        ...
        public ContextProperties GetContextProperties()
        {
            ...
            if (HttpContext.Current != null)
            {
                ...
                if (request != null)
                {
                    ...
                    props.CurrentUrl = request.Url.ToString();
                    props.Host = request.Url.GetLeftPart(UriPartial.Authority);
                    props.BaseSiteUrl = request.Url.GetLeftPart(UriPartial.Authority) + request.ApplicationPath.TrimEnd('/');
                }
